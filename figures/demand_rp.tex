...
\begin{tikzpicture}[show background rectangle, background rectangle/.style={fill=white}]
    ...
    \addplot+[mark=none, line width=1.5pt, smooth, color=blue] coordinates {
    ...
    \addplot+[mark=none, line width=1.5pt, smooth, color=green] coordinates {
    ...
    \addplot+[mark=none, line width=1.5pt, smooth, color=yellow] coordinates {
