...
\newcommand{\reportauthorlist}{%
    ...
    \reportauthorentry{Robert Gaugl}{Assistant Professor}{\href{mailto:example@email.com}{example@email.com}}
    \reportauthorentry{Alexa Author}{Project Assistant}{\href{mailto:alexa.author@email.com}{alexa.author@email.com}}

    \reportauthorcompany{Partner Company 1}
    \reportauthorentry{Brian Author}{Team Leader}{\href{mailto:brian.author@email.com}{brian.author@email.com}}
}
