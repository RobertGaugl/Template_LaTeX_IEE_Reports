...
\newcommand{\reportauthorlist}{%
    ...
    % \reportauthorentry{Name}{Role}{\href{mailto:email}{email}}
    \reportauthorentry{Robert Gaugl}{Assistant Professor}{}
    \reportauthorentry{Alexa Author}{Project Assistant}{}

    \reportauthorcompany{Partner Company 1}
    \reportauthorentry{Brian Author}{Team Leader}{}
}
