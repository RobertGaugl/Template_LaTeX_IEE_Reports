...
\ieeline
\sideIcon{\vspace{0.2cm}\fontsize{36}{40}\selectfont\color{blue}\faIcon{sitemap}}{center}
...
\ieeline
\sideIcon{\vspace{0.2cm}\fontsize{36}{40}\selectfont\color{blue}\faIcon{paintbrush}}{center}
...
\ieeline
\sideIcon{\vspace{0.2cm}\fontsize{36}{40}\selectfont\color{blue}\faIcon{recycle}}{center}
